...
//U32 addrShort2 = 0x0800C000 + 11 * 8; // 2
	...
	switch(cmd){
		...
		case 2:
			  System_WriteInteriorFlash(addrShort7, (uint8_t *)&device_state_init.Alarm3_hour, sizeof(device_state_init.Alarm3_hour)); // 存入数据，函数内自动解锁，擦除，写入
				System_WriteInteriorFlash(addrShort8, (uint8_t *)&device_state_init.Alarm4_hour, sizeof(device_state_init.Alarm4_hour)); // 存入数据，函数内自动解锁，擦除，写入
				...
				System_WriteInteriorFlash(addrShort10, (uint8_t *)&device_state_init.Alarm4_min, sizeof(device_state_init.Alarm4_min)); // 存入数据，函数内自动解锁，擦除，写入
			break;
...
void R_Test(void)
{
    ...
    System_ReadInteriorFlash(addrShort8, (uint8_t *)&device_state_init.Alarm4_hour, sizeof(device_state_init.Alarm4_hour)); // 存入数据，函数内自动解锁，擦除，写入
    ...
    System_ReadInteriorFlash(addrShort10, (uint8_t *)&device_state_init.Alarm4_min, sizeof(device_state_init.Alarm4_min)); // 存入数据，函数内自动解锁，擦除，写入
